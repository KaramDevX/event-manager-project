...
event1 = manager.create_event("Tech Conference", "2026-04-10", 2)
event2 = manager.create_event("Music Festival", "2026-04-15", 3)
manager.register_attendee(event1.id, "Alice", "alice@example.com")
manager.register_attendee(event2.id, "Bob", "bob@example.com")
print(manager.attendance_statistics())
