...
event = manager.create_event("Tech Conference", "2026-04-10", 3)
manager.register_attendee(event.id, "Alice", "alice@example.com")
manager.register_attendee(event.id, "Bob", "bob@example.com")
print(manager.show_attendees(event.id))
