...
manager.set_reminder_days(7)
manager.create_event("Tech Conference", "2026-04-10", 2)
manager.create_event("Art Expo", "2026-05-01", 3)
for reminder in manager.simple_reminders("2026-04-08"):
    print(reminder)
