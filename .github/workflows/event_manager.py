...
event = manager.create_event("Tech Conference", "2026-04-10", 100, "Annual meetup")
print(event)
from __future__ import annotations
...
manager = EventManager()
event = manager.create_event("Tech Conference", "2026-04-10", 100)
...
manager = EventManager()
manager.create_event("B Event", "2026-05-10", 50)
manager.create_event("A Event", "2026-04-10", 50)
